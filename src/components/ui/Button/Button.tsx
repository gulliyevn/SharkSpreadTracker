...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseClasses =
      'inline-flex items-center justify-center font-medium rounded-lg transition-colors focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation';

    const variantClasses = {
      primary:
        'bg-primary-600 text-white hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600',
      secondary:
        'bg-light-200 text-dark-950 hover:bg-light-300 dark:bg-dark-700 dark:text-dark-50 dark:hover:bg-dark-600',
      outline:
      ...
      ghost:
        'text-dark-950 hover:bg-light-100 dark:text-dark-50 dark:hover:bg-dark-800',
      danger:
